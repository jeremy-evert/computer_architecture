...
Commands are observation instruments, not detached memorization.

## Monday - Think / Frame / Lecture
**Labor Day - no Monday requirement.**

**AI Fluency Lens 4: Decompose the Task** folds into Wednesday's opening: turn a vague machine question into smaller observable questions.
...
Jeremy may showcase how the same question is answered on one of his real Linux systems using the larger tool stack.

## Evidence this week
A machine-observation receipt containing commands, relevant output, and an evidence-backed explanation.

## Machine Dossier role
None. Week 4 teaches the observation instruments the dossier begins using in Week 5.
