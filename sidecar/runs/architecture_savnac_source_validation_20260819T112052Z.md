...
- UTC: 20260819T112052Z
- status: **GREEN WITH YELLOWS**
- commit: `c3f795f53e35763578ff4206d4a8dd3bbf4ad9d5`
- host: `brandy`
- Python: `3.11.13`
...
```text
python=3.11.13; system=Linux; machine=x86_64; logical_cpus=96
```
...
```text
{
  ...
  "status": "FAIL",
  "timestamp_utc": "2026-08-19T11:20:53.040683+00:00",
  "tools": {
    "clang": null,
    "docker": null,
    "file": "/usr/bin/file",
